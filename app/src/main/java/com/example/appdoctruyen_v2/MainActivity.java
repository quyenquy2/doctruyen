...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        phanquyen =intentpq.getIntExtra("phanq",0);
        pass=intentpq.getStringExtra("pass");
        ...
        public boolean onNavigationItemSelected(@NonNull android.view.MenuItem item) {
            ...
            switch (item.getItemId()) {
                case R.id.navigation_shop:
                    ...
                    return true;
                case R.id.navigation_QL:
                    fragment = new QuanLyFragment();
                    loadFragment(fragment);
                    sNavigationDrawer.setAppbarTitleTV("QL Truyện");
                    return true;
    ...
    public void init(){
        ...
        menuItems.add(new MenuItem("Quản lý tài khoản",R.drawable.feed_bg));
        ...
        sNavigationDrawer.setOnMenuItemClickListener(new SNavigationDrawer.OnMenuItemClickListener() {
            ...
            public void onMenuItemClicked(int position) {
                ...
                switch (position){
                    ...
                    case 1:{
                        fragmentClass = AccountFragmment.class;
                        break;
                    }
                    case 2:{
