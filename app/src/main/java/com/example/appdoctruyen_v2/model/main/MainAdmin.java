...
import com.example.appdoctruyen_v2.MainThemTruyen;
...
public class MainAdmin extends AppCompatActivity {
      ...
      /*  listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
        ...
        buttonThem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent1 = new Intent(MainAdmin.this, MainThemTruyen.class);
    ...
    public void initList(){
        ...
        while (cursor1.moveToNext()){
            ...
            int slyt = cursor1.getInt(4);
            TruyenArrayList.add(new Truyen(tentruyen,noidung,anh,slyt,System.currentTimeMillis()));
